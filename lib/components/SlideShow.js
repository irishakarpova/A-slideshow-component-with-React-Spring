...
var SlideShow = function SlideShow(props) {
    ...
    var serverData = props.serverData,
    ...
    var classes = (0, _style.useStyles)(width, containerMaxWidth, containerRatio, iShadow, cShadow)();
    ...
    var _useState = (0, _react.useState)(0),
        ...
        scrollFiredOn = _useState2[0],
        setScrollFiredOn = _useState2[1];
    ...
    var _useState3 = (0, _react.useState)(null),
        ...
        currentImg = _useState4[0],
        setCurrentImg = _useState4[1];

    var _useState5 = (0, _react.useState)(false),
        _useState6 = _slicedToArray(_useState5, 2),
        isOpenCurrentImg = _useState6[0],
        setIsOpenCurrentImg = _useState6[1];
