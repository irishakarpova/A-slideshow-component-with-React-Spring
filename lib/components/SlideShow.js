...
const SlideShow = props => {
  ...
  return /*#__PURE__*/React.createElement("div", null, isOpenCurrentImg ? /*#__PURE__*/React.createElement(Paper, null, /*#__PURE__*/React.createElement(Fab, {
    onClick: handleClose,
    ...
    style: {
      display,
      transform: x !== undefined && x.interpolate(x => `translate3d(${x}px,0,0)`)
    }
  }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(animated.source, {
    ...
    style: {
      display,
      transform: sc !== undefined && sc.interpolate(s => `scale(${s})`)
    }
  })))) : null)));
};
