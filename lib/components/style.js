...
var useStyles = exports.useStyles = function useStyles(width, containerMaxWidth, containerRatio, iShadow, cShadow) {
    return (0, _styles.makeStyles)(function (theme) {
        ...
        return {
            ...
            appExt: (_appExt = {
                ...
                width: '100%',
                padding: 20
            }, _defineProperty(_appExt, theme.breakpoints.down('xs'), {
                padding: 0
            }), _defineProperty(_appExt, 'height', '100%'), _defineProperty(_appExt, 'overflow', 'hidden'), _appExt),
            appInt: {
                position: 'absolute',
                width: '100%',
                height: '100%',
